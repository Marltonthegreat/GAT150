...
namespace glds
{
	struct Matrix22
	{
		...
		Matrix22 operator * (const Matrix22& mtx) const;
	...
	{
		m[0][1] = column1[1]; m[1][1] = column2[0];
		m[0][0] = column1[0]; m[1][0] = column2[1];
	}
	...
	inline Matrix22 Matrix22::operator*(const Matrix22& mtx) const
	{
		Matrix22 result;

		result.m[0][0] = m[0][0] * mtx.m[0][0] + m[1][0] * mtx.m[0][1];
		result.m[1][0] = m[0][0] * mtx.m[1][0] + m[1][0] * mtx.m[1][1];
		result.m[0][1] = m[0][1] * mtx.m[0][0] + m[1][1] * mtx.m[0][1];
		result.m[1][1] = m[0][1] * mtx.m[1][0] + m[1][1] * mtx.m[1][1];
