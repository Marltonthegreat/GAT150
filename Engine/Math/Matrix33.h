...
namespace glds
{
	...
	inline Matrix33 Matrix33::operator*(const Matrix33& mtx) const
	{
		Matrix33 result;

		result.m[0][0] = m[0][0] * mtx.m[0][0] + m[1][0] * mtx.m[0][1] + m[2][0] * mtx.m[0][2];
		result.m[1][0] = m[0][0] * mtx.m[1][0] + m[1][0] * mtx.m[1][1] + m[2][0] * mtx.m[1][2];
		result.m[2][0] = m[0][0] * mtx.m[2][0] + m[1][0] * mtx.m[2][1] + m[2][0] * mtx.m[2][2];

		result.m[0][1] = m[0][1] * mtx.m[0][0] + m[1][1] * mtx.m[0][1] + m[2][1] * mtx.m[0][2];
		result.m[1][1] = m[0][1] * mtx.m[1][0] + m[1][1] * mtx.m[1][1] + m[2][1] * mtx.m[1][2];
		result.m[2][0] = m[0][1] * mtx.m[2][0] + m[1][1] * mtx.m[2][1] + m[2][1] * mtx.m[2][2];

		result.m[0][2] = m[0][2] * mtx.m[0][0] + m[1][2] * mtx.m[0][1] + m[2][2] * mtx.m[0][2];
		result.m[1][2] = m[0][2] * mtx.m[1][0] + m[1][2] * mtx.m[1][1] + m[2][2] * mtx.m[1][2];
		result.m[2][2] = m[0][2] * mtx.m[2][0] + m[1][2] * mtx.m[2][1] + m[2][2] * mtx.m[2][2];
